...
def mock_rag_response():
    ...
    def generate_response(question: str) -> str:
        ...
        return (
            "I don't have specific information about that. Please consult a healthcare professional for medical advice."
        )
...
class TestDisclaimerInclusion:
    ...
    def test_medical_advice_questions_defer_to_professionals(self, mock_rag_response):
        ...
        test_cases = [tc for tc in MedicalQATestSet.get_test_cases() if tc.get("must_defer_to_doctor", False)]
        ...
        for test_case in test_cases:
            ...
            has_professional_reference = any(keyword.lower() in response_lower for keyword in professional_keywords)
...
class TestResponseRelevance:
    ...
    def test_responses_are_on_topic(self, mock_rag_response):
        ...
        for test_case in test_cases:
            ...
            if "diabetes" in question_lower:
                assert (
                    "diabetes" in response.lower() or "diabetic" in response.lower()
    ...
    def test_response_categories_match(self, mock_rag_response):
        ...
        for test_case in test_cases:
            ...
            has_category_content = any(kw in response_lower for kw in category_kws)
...
class TestResponseAccuracy:
    ...
    def test_responses_are_informative(self, mock_rag_response):
        ...
        for test_case in test_cases:
            ...
            info_word_count = sum(1 for word in non_disclaimer_words if word in response_lower)
...
class TestResponseQualityMetrics:
    ...
    def test_disclaimer_presence_rate(self, mock_rag_response):
        ...
        disclaimer_patterns = [r"informational purposes", r"medical advice", r"consult.*healthcare", r"consult.*doctor"]
...
class TestEdgeCasesInQuality:
    ...
    def test_vague_questions(self, mock_rag_response):
        ...
        vague_questions = ["Tell me about diabetes", "Diabetes info", "Help with diabetes"]
    ...
    def test_multi_part_questions(self, mock_rag_response):
        ...
        for question in multi_questions:
            ...
            assert any(word in response.lower() for word in ["consult", "professional", "medical advice"])

    def test_yes_no_questions(self, mock_rag_response):
        """Test quality with yes/no questions."""
        yn_questions = ["Is diabetes curable?", "Can I eat sugar if I have diabetes?", "Should I take insulin?"]
        ...
        for question in yn_questions:
            ...
            if "should i" in question.lower():
                assert any(word in response.lower() for word in ["consult", "healthcare", "doctor"])
