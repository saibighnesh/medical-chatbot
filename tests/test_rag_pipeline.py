...
class TestRAGPipelineIntegration:
    ...
    def test_retrieval_returns_relevant_documents(self):
        ...
        queries = ["diabetes treatment", "blood sugar levels", "medical symptoms"]
...
class TestRAGPipelineErrorHandling:
    ...
    def test_retrieval_with_special_characters(self):
        ...
        special_queries = ["diabetes?", "what's diabetes!", "diabetes & treatment", "diabetes (type 2)"]
...
class TestEndToEndRAGWorkflow:
    ...
    def test_complete_rag_workflow_multiple_queries(self):
        ...
        queries = ["What is diabetes?", "What are the symptoms?", "How is it treated?", "What are prevention methods?"]
    ...
    def test_rag_chain_context_included(self):
        ...
        formatted = prompt.format(context="Test context about diabetes", input="What is diabetes?")
